...
if __name__ == '__main__':
    ...
    parser.add_argument('--use_val', help='Track validation metrics during training (default False)', action='store_false')
    ...
    parser.add_argument('--using_windows', help='Whether the script is being executed on a Windows machine (default=False)', action='store_false')
