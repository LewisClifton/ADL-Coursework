...
if __name__ == '__main__':
    ...
    parser.add_argument('--use_val', type=bool, help='Track validation metrics during training', action='store_true')
    ...
    parser.add_argument('--using_windows', type=bool, help='Whether the script is being executed on a Windows machine (default=False)', action='store_true')
